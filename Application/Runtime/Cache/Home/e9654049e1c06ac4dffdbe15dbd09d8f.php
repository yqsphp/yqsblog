...
<div class="am-g am-g-fixed blog-fixed blog-content">
	<div class="am-u-sm-12">
		...
		<div class="timeline-year">
			<?php if(is_array($doc)): foreach($doc as $k=>$v): ?><ul>
				<h3><?php echo ($k); ?></h3>
				<hr>
				<?php if(is_array($v)): $i = 0; $__LIST__ = $v;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo['time']) == $k): ?><li class="am-g">
						<span class="am-u-sm-4 am-u-md-2 timeline-span"><?php echo ($vo["ptime"]); ?></span>
						<span class="am-u-sm-8 am-u-md-6 blog-line-clamp-1"><a href="<?php echo getArticleUrl($vo['catid'],$vo['id'],2);?>"><?php echo ($vo["name"]); ?></a></span>
						<span class="am-u-sm-4 am-u-md-2 am-hide-sm-only"><?php echo ($vo["catename"]); ?></span>
						<span class="am-u-sm-8 am-u-md-2 am-hide-sm-only"><?php echo ($vo["editor"]); ?></span>
