...
final class Tree{
     ...
     * @return bool
     */
    static public function isChild($data, $sid, $pid, $fieldPri = 'id', $fieldPid = 'pid'){
     ...
     * @return bool
     */
    static public function hasChild($data, $cid, $fieldPid = 'pid'){
        foreach ($data as $d) {
     ...
     * @return array
     */
    static public function descarte($arr, $tmp = array()){
        static $n_arr = array();
