...
class Page{
    ...
    private function url($page){
    	//2018年9月12日 11:09:11改动，当条件很复杂是直接传它的查询字符串并返回
    	if(is_string($this->url)){
    		$pre = '/&p=\d+/i';
    		$this->url = preg_replace($pre, '', $this->url);
    		if(strpos($this->url, urlencode('[PAGE]')) !== false){
    ...
    public function show() {
        ...
        //2018年9月12日 11:09:11改动，当条件很复杂是直接传它的查询字符串而不是数组
